...
<body>
      ...
      <div class="container">
        ...
        <div class="row skills-content">
          ...
          <div class="col-lg-6">
            ...
            <div class="progress">
              <span class="skill">Nextjs <i class="val">75%</i></span>
              <div class="progress-bar-wrap">
                <div class="progress-bar" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100">
                </div>
              </div>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            ...
            <div class="resume-item">
              <h4>Keyless (https://register.keyless.ae)</h4>
              <ul>
                <li>Designed and implemented an admin panel allowing centralized management of
                  managers, users, properties, and locks using Nextjs, NestJs and MongoDB.</li>
                <li>Created individual manager panels enabling decentralized management of
                  properties, locks and guests.</li>
                <li>Developed RESTful APIs to facilitate communication between the web application
                  and a mobile application.</li>
                <li>Implemented user authentication and authorization mechanisms across different
                  panels and API endpoints.</li>
              </ul>
              </p>
            </div>
            <div class="resume-item">
              <h4>Citify (https://citify.com)</h4>
              <ul>
                <li>Developed a dynamic web application using Next.js 14 and App Router for
                  Citify.com, a platform connecting buyers and agents in real estate transactions.</li>
                <li>Implemented user authentication and authorization systems for buyer and agent
                  roles.</li>
                <li>Developed RESTful APIs to facilitate communication between the web application
                  and a mobile application.</li>
                <li>Designed and developed features allowing buyers to schedule property tours and
                  agents to manage and accept leads post-payment.</li>
                <li>Integrated Google Maps API to display property locations and facilitate
                  location-based search functionalities.</li>
                <li>Implemented favorite property and cart management features, allowing users to
                  save and manage property selections.</li>
                <li>Developed mortgage and commission calculators to aid users in financial
                  planning during property transactions.</li>
              </ul>
              </p>
            </div>
            <div class="resume-item pb-0">
              <h4>Novatoons (https://novatoons.com)</h4>
              <ul>
                <li>Developed and maintained the backend infrastructure for Novatoons.com, a
                  platform for uploading, managing, and monetizing comics.</li>
                <li>Designed and implemented RESTful APIs to support frontend interactions,
                  including user authentication, comic upload, series management, and point
                  transactions.</li>
                <li>Integrated Stripe API for secure and seamless payment processing, enabling
                  users to purchase points and access paid comics.</li>
                <li>Implemented a points system where users earn and spend points based on their
                  comic reading activity, with corresponding adjustments to creator accounts.</li>
                <li>Designed and optimized database schema using MySQL for efficient data storage
                  and retrieval.</li>
              </ul>
              </p>
            </div>
 ...
 -->
          ...
          <div class="col-lg-6 col-md-6">
            <div class="contact-about">
              ...
              <div class="social-links">
                <a href="https://x.com/ItsSurajChand" class="twitter"><i class="bi bi-twitter"></i></a>
  ...
  <footer id="footer">
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>Suraj</span></strong>. All Rights Reserved
      </div>
      <!--   <div class="credits">
